...
class Calculator extends ExtendedCalculator{
    ...
    public static void main(String[] args){
        ...
        float result1=calc.square(operand_1);
        System.out.println("Square of number is:"+result1);
        float result2=calc.cube(operand_1);
        System.out.println("Cube of number is:"+result2);
